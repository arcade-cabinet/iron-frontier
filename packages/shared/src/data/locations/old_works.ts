...
import { Location, validateLocation, SlotInstance, TileDef } from '../schemas/spatial';
...
const dungeonSlots: SlotInstance[] = [
  ...
  // -------------------------------------------------------------------------
  {
    ...
    markers: [
      { type: 'entrance', name: 'secret_door', offset: { q: 0, r: 0 }, facing: 5, tags: ['hidden', 'main'] },
      { type: 'evidence_spot', name: 'old_insignia', offset: { q: 1, r: 0 }, tags: ['clue', 'union'] },
    ],
    zones: [
      { type: 'public_area', name: 'entrance_area', tiles: [{ q: 0, r: 0 }, { q: 0, r: 1 }], tags: ['transition'] },
    ],
  ...
  // -------------------------------------------------------------------------
  {
    ...
    markers: [
      { type: 'entrance', name: 'tunnel_start', offset: { q: 0, r: 4 }, facing: 5, tags: ['from_entrance'] },
      { type: 'exit', name: 'tunnel_end', offset: { q: 0, r: 0 }, facing: 2, tags: ['to_assembly'] },
      { type: 'hiding_spot', name: 'rubble_cover', offset: { q: -1, r: 1 }, tags: ['cover'] },
      { type: 'evidence_spot', name: 'old_lantern', offset: { q: 1, r: 2 }, tags: ['clue', 'atmosphere'] },
    ],
    zones: [
      { type: 'public_area', name: 'tunnel_path', tiles: [{ q: 0, r: 0 }, { q: 0, r: 1 }, { q: 0, r: 2 }, { q: 0, r: 3 }, { q: 0, r: 4 }], tags: ['passage'] },
      { type: 'combat_zone', name: 'ambush_point', tiles: [{ q: 0, r: 2 }, { q: -1, r: 1 }, { q: 1, r: 2 }], tags: ['dangerous', 'automaton'] },
    ],
  ...
  // -------------------------------------------------------------------------
  {
    ...
    markers: [
      ...
      { type: 'workbench', name: 'assembly_line_1', offset: { q: -2, r: 0 }, tags: ['machinery', 'rusted'] },
      { type: 'workbench', name: 'assembly_line_2', offset: { q: 2, r: 0 }, tags: ['machinery', 'rusted'] },
      { type: 'spawn_point', name: 'automaton_patrol_1', offset: { q: 0, r: 0 }, tags: ['hostile', 'automaton', 'patrol'] },
      { type: 'spawn_point', name: 'automaton_patrol_2', offset: { q: -2, r: 1 }, tags: ['hostile', 'automaton', 'patrol'] },
      { type: 'spawn_point', name: 'automaton_static', offset: { q: 2, r: 1 }, tags: ['hostile', 'automaton', 'dormant'] },
      { type: 'vantage_point', name: 'east_catwalk', offset: { q: 3, r: 0 }, tags: ['elevated', 'tactical'] },
      { type: 'vantage_point', name: 'west_catwalk', offset: { q: -3, r: 0 }, tags: ['elevated', 'tactical'] },
      { type: 'evidence_spot', name: 'half_built_automaton', offset: { q: 0, r: -1 }, tags: ['clue', 'lore', 'important'] },
      { type: 'evidence_spot', name: 'production_manifest', offset: { q: -1, r: -1 }, tags: ['clue', 'document'] },
      { type: 'storage', name: 'parts_crate', offset: { q: 1, r: -1 }, tags: ['loot', 'mechanical'] },
      { type: 'exit', name: 'to_power_station', offset: { q: -3, r: 1 }, facing: 3, tags: ['west'] },
      { type: 'exit', name: 'to_barracks', offset: { q: 3, r: 1 }, facing: 0, tags: ['east'] },
      { type: 'exit', name: 'to_command', offset: { q: 0, r: -2 }, facing: 2, tags: ['north', 'locked'] },
    ],
    zones: [
      { type: 'public_area', name: 'main_floor', tiles: [{ q: 0, r: 0 }, { q: 1, r: 0 }, { q: -1, r: 0 }, { q: 0, r: 1 }, { q: 1, r: 1 }, { q: -1, r: 1 }], tags: ['open'] },
      { type: 'combat_zone', name: 'assembly_combat', tiles: [{ q: 0, r: 0 }, { q: 1, r: 0 }, { q: -1, r: 0 }, { q: 2, r: 0 }, { q: -2, r: 0 }, { q: 0, r: 1 }, { q: 1, r: 1 }, { q: -1, r: 1 }], priority: 1, tags: ['dangerous', 'automaton_patrol'] },
      { type: 'loot_area', name: 'workbenches', tiles: [{ q: -2, r: 0 }, { q: 2, r: 0 }, { q: 1, r: -1 }], tags: ['mechanical', 'valuable'] },
    ],
  ...
  // -------------------------------------------------------------------------
  {
    ...
    markers: [
      { type: 'entrance', name: 'from_assembly', offset: { q: 2, r: 0 }, facing: 0, tags: ['main'] },
      { type: 'workbench', name: 'generator_1', offset: { q: 0, r: 0 }, tags: ['machinery', 'active', 'dangerous'] },
      { type: 'workbench', name: 'generator_2', offset: { q: -1, r: 0 }, tags: ['machinery', 'broken'] },
      { type: 'workbench', name: 'generator_3', offset: { q: 1, r: 0 }, tags: ['machinery', 'active', 'dangerous'] },
      { type: 'ambush_trigger', name: 'steam_vent_1', offset: { q: 0, r: 1 }, tags: ['hazard', 'steam'] },
      { type: 'ambush_trigger', name: 'steam_vent_2', offset: { q: -1, r: 1 }, tags: ['hazard', 'steam'] },
      { type: 'spawn_point', name: 'automaton_engineer', offset: { q: 1, r: -1 }, tags: ['hostile', 'automaton', 'worker'] },
      { type: 'evidence_spot', name: 'power_controls', offset: { q: 0, r: -1 }, tags: ['clue', 'important', 'interactive'] },
      { type: 'storage', name: 'coal_reserve', offset: { q: -2, r: 0 }, tags: ['resources'] },
      { type: 'exit', name: 'to_furnace', offset: { q: -2, r: -2 }, facing: 2, tags: ['down', 'heat'] },
    ],
    zones: [
      { type: 'combat_zone', name: 'generator_floor', tiles: [{ q: 0, r: 0 }, { q: 1, r: 0 }, { q: -1, r: 0 }, { q: 0, r: 1 }, { q: 1, r: 1 }, { q: -1, r: 1 }], tags: ['hazardous', 'steam_vents'] },
      { type: 'restricted_area', name: 'active_generators', tiles: [{ q: 0, r: 0 }, { q: 1, r: 0 }], priority: 2, tags: ['dangerous', 'operational'] },
      { type: 'loot_area', name: 'supplies', tiles: [{ q: -2, r: 0 }, { q: 1, r: -1 }], tags: ['resources'] },
    ],
  ...
  // -------------------------------------------------------------------------
  {
    ...
    markers: [
      { type: 'entrance', name: 'from_assembly', offset: { q: -1, r: 0 }, facing: 3, tags: ['main'] },
      ...
      { type: 'evidence_spot', name: 'old_photograph', offset: { q: 0, r: 1 }, tags: ['clue', 'story', 'emotional'] },
      { type: 'evidence_spot', name: 'journal_entry', offset: { q: 1, r: 1 }, tags: ['clue', 'document', 'important'] },
      { type: 'evidence_spot', name: 'union_medal', offset: { q: 2, r: 0 }, tags: ['clue', 'historical'] },
      { type: 'exit', name: 'to_mess_hall', offset: { q: 2, r: 1 }, facing: 0, tags: ['east'] },
      { type: 'exit', name: 'to_testing_ground', offset: { q: 1, r: -1 }, facing: 2, tags: ['north'] },
    ],
    zones: [
      { type: 'public_area', name: 'common_area', tiles: [{ q: 0, r: 1 }, { q: 1, r: 1 }, { q: -1, r: 0 }, { q: -1, r: 1 }], tags: ['empty'] },
      { type: 'loot_area', name: 'bunks', tiles: [{ q: 0, r: 0 }, { q: 1, r: 0 }, { q: 2, r: 0 }], tags: ['personal', 'low_value'] },
    ],
  ...
  // -------------------------------------------------------------------------
  {
    ...
    markers: [
      { type: 'entrance', name: 'from_assembly', offset: { q: 0, r: 2 }, facing: 5, tags: ['main', 'locked'] },
      { type: 'desk', name: 'command_console', offset: { q: 0, r: 0 }, tags: ['important', 'interactive', 'final_choice'] },
      { type: 'spawn_point', name: 'the_foreman', offset: { q: 0, r: -1 }, facing: 5, tags: ['boss', 'automaton', 'important'] },
      { type: 'spawn_point', name: 'guard_automaton_1', offset: { q: 2, r: 0 }, tags: ['hostile', 'automaton', 'elite'] },
      { type: 'spawn_point', name: 'guard_automaton_2', offset: { q: -2, r: 0 }, tags: ['hostile', 'automaton', 'elite'] },
      { type: 'evidence_spot', name: 'original_orders', offset: { q: -1, r: -1 }, tags: ['clue', 'document', 'critical'] },
      { type: 'evidence_spot', name: 'telegraph_machine', offset: { q: 1, r: -1 }, tags: ['clue', 'communication', 'important'] },
      { type: 'evidence_spot', name: 'ivrc_correspondence', offset: { q: 1, r: 0 }, tags: ['clue', 'villain', 'revelation'] },
      { type: 'vault', name: 'command_safe', offset: { q: -1, r: 0 }, tags: ['secure', 'valuable'] },
      { type: 'exit', name: 'to_armory', offset: { q: 2, r: 0 }, facing: 0, tags: ['east'] },
      { type: 'exit', name: 'to_storage_vaults', offset: { q: -2, r: 0 }, facing: 3, tags: ['west'] },
    ],
    zones: [
      { type: 'combat_zone', name: 'boss_arena', tiles: [{ q: 0, r: 0 }, { q: 1, r: 0 }, { q: -1, r: 0 }, { q: 0, r: 1 }, { q: 1, r: 1 }, { q: -1, r: 1 }, { q: 0, r: -1 }], priority: 2, tags: ['boss_fight', 'critical'] },
      { type: 'event_stage', name: 'final_choice', tiles: [{ q: 0, r: 0 }, { q: 0, r: -1 }], priority: 3, tags: ['story', 'ending'] },
      { type: 'loot_area', name: 'command_valuables', tiles: [{ q: -1, r: 0 }, { q: 1, r: -1 }], tags: ['high_value'] },
    ],
  ...
  // -------------------------------------------------------------------------
  {
    ...
    markers: [
      { type: 'entrance', name: 'from_command', offset: { q: -1, r: 0 }, facing: 3, tags: ['main'] },
      { type: 'display', name: 'rifle_rack_1', offset: { q: 0, r: 0 }, tags: ['weapons', 'civil_war'] },
      { type: 'display', name: 'rifle_rack_2', offset: { q: 1, r: 0 }, tags: ['weapons', 'civil_war'] },
      { type: 'storage', name: 'ammo_crates', offset: { q: 0, r: -1 }, tags: ['ammunition', 'valuable'] },
      { type: 'storage', name: 'explosive_crates', offset: { q: 1, r: 1 }, tags: ['explosives', 'dangerous'] },
      { type: 'storage', name: 'prototype_weapons', offset: { q: -1, r: 1 }, tags: ['weapons', 'unique', 'valuable'] },
      { type: 'spawn_point', name: 'armory_guard', offset: { q: 0, r: 1 }, tags: ['hostile', 'automaton'] },
      { type: 'evidence_spot', name: 'weapons_manifest', offset: { q: 0, r: 2 }, tags: ['clue', 'document'] },
    ],
    zones: [
      { type: 'loot_area', name: 'weapon_storage', tiles: [{ q: 0, r: 0 }, { q: 1, r: 0 }, { q: -1, r: 0 }, { q: 0, r: -1 }, { q: -1, r: 1 }], priority: 1, tags: ['high_value', 'weapons'] },
      { type: 'restricted_area', name: 'explosives', tiles: [{ q: 1, r: 1 }], priority: 2, tags: ['dangerous'] },
    ],
  ...
  // -------------------------------------------------------------------------
  {
    ...
    markers: [
      { type: 'entrance', name: 'from_barracks', offset: { q: -2, r: 2 }, facing: 4, tags: ['main'] },
      { type: 'spawn_point', name: 'patrol_automaton_1', offset: { q: 0, r: 0 }, tags: ['hostile', 'automaton', 'patrol'] },
      { type: 'spawn_point', name: 'patrol_automaton_2', offset: { q: 2, r: 1 }, tags: ['hostile', 'automaton', 'patrol'] },
      { type: 'spawn_point', name: 'patrol_automaton_3', offset: { q: -2, r: -1 }, tags: ['hostile', 'automaton', 'patrol'] },
      { type: 'spawn_point', name: 'heavy_automaton', offset: { q: 0, r: -1 }, tags: ['hostile', 'automaton', 'elite', 'miniboss'] },
      { type: 'vantage_point', name: 'observation_deck', offset: { q: 3, r: 0 }, tags: ['elevated', 'tactical'] },
      ...
      { type: 'evidence_spot', name: 'target_dummies', offset: { q: 1, r: -1 }, tags: ['atmosphere'] },
      { type: 'evidence_spot', name: 'test_records', offset: { q: 3, r: 1 }, tags: ['clue', 'document'] },
      { type: 'exit', name: 'to_maintenance', offset: { q: 3, r: -1 }, facing: 0, tags: ['east'] },
    ],
    zones: [
      { type: 'combat_zone', name: 'testing_floor', tiles: [{ q: 0, r: 0 }, { q: 1, r: 0 }, { q: 2, r: 0 }, { q: -1, r: 0 }, { q: -2, r: 0 }, { q: 0, r: 1 }, { q: 1, r: 1 }, { q: -1, r: 1 }, { q: 0, r: -1 }, { q: 1, r: -1 }, { q: -1, r: -1 }], priority: 1, tags: ['patrol_zone', 'dangerous'] },
      { type: 'npc_area', name: 'patrol_route', tiles: [{ q: 0, r: 0 }, { q: 2, r: 0 }, { q: 2, r: 1 }, { q: 0, r: 1 }, { q: -2, r: 0 }, { q: -2, r: -1 }, { q: 0, r: -1 }], tags: ['automaton_patrol'] },
    ],
  ...
  // -------------------------------------------------------------------------
  {
    ...
    markers: [
      { type: 'entrance', name: 'from_testing', offset: { q: -1, r: 0 }, facing: 3, tags: ['main'] },
      { type: 'workbench', name: 'repair_station_1', offset: { q: 0, r: 0 }, tags: ['machinery', 'repair'] },
      { type: 'workbench', name: 'repair_station_2', offset: { q: 1, r: 0 }, tags: ['machinery', 'repair'] },
      { type: 'spawn_point', name: 'damaged_automaton', offset: { q: 0, r: 1 }, tags: ['hostile', 'automaton', 'damaged'] },
      { type: 'spawn_point', name: 'repair_automaton', offset: { q: 1, r: 1 }, tags: ['neutral', 'automaton', 'worker'] },
      { type: 'storage', name: 'spare_parts', offset: { q: 0, r: -1 }, tags: ['mechanical', 'valuable'] },
      { type: 'storage', name: 'tools', offset: { q: 1, r: -1 }, tags: ['tools'] },
      { type: 'evidence_spot', name: 'repair_logs', offset: { q: -1, r: 1 }, tags: ['clue', 'technical'] },
    ],
    zones: [
      { type: 'public_area', name: 'repair_floor', tiles: [{ q: 0, r: 0 }, { q: 1, r: 0 }, { q: 0, r: 1 }, { q: 1, r: 1 }], tags: ['workshop'] },
      { type: 'loot_area', name: 'parts_storage', tiles: [{ q: 0, r: -1 }, { q: 1, r: -1 }], tags: ['mechanical'] },
    ],
  ...
  // -------------------------------------------------------------------------
  {
    ...
    markers: [
      { type: 'entrance', name: 'from_power_station', offset: { q: 0, r: -1 }, facing: 5, tags: ['main'] },
      { type: 'workbench', name: 'main_furnace', offset: { q: 0, r: 0 }, tags: ['machinery', 'heat', 'critical'] },
      { type: 'ambush_trigger', name: 'heat_vent_1', offset: { q: 1, r: 1 }, tags: ['hazard', 'heat'] },
      { type: 'ambush_trigger', name: 'heat_vent_2', offset: { q: -1, r: 1 }, tags: ['hazard', 'heat'] },
      { type: 'ambush_trigger', name: 'unstable_floor', offset: { q: 0, r: 2 }, tags: ['hazard', 'collapse'] },
      { type: 'spawn_point', name: 'furnace_automaton', offset: { q: 1, r: 0 }, tags: ['hostile', 'automaton', 'heat_resistant'] },
      { type: 'evidence_spot', name: 'fuel_source', offset: { q: -1, r: 0 }, tags: ['clue', 'technical', 'important'] },
      { type: 'storage', name: 'coal_stockpile', offset: { q: 0, r: 1 }, tags: ['fuel'] },
    ],
    zones: [
      { type: 'combat_zone', name: 'furnace_chamber', tiles: [{ q: 0, r: 0 }, { q: 1, r: 0 }, { q: -1, r: 0 }, { q: 0, r: 1 }, { q: 1, r: 1 }, { q: -1, r: 1 }], priority: 1, tags: ['hazardous', 'heat'] },
      { type: 'restricted_area', name: 'heat_zone', tiles: [{ q: 0, r: 2 }, { q: 1, r: 2 }, { q: -1, r: 2 }], priority: 2, tags: ['deadly', 'environmental'] },
    ],
  ...
  // -------------------------------------------------------------------------
  {
    ...
    markers: [
      ...
      { type: 'vault', name: 'vault_1_blueprints', offset: { q: 1, r: 0 }, tags: ['locked', 'documents'] },
      { type: 'vault', name: 'vault_2_prototypes', offset: { q: -1, r: 0 }, tags: ['locked', 'weapons'] },
      { type: 'vault', name: 'vault_3_records', offset: { q: 1, r: 1 }, tags: ['locked', 'historical'] },
      { type: 'vault', name: 'vault_4_gold', offset: { q: -1, r: 1 }, tags: ['locked', 'valuable'] },
      { type: 'vault', name: 'vault_5_classified', offset: { q: 1, r: -1 }, tags: ['locked', 'secret', 'important'] },
      { type: 'vault', name: 'vault_6_personal', offset: { q: -1, r: -1 }, tags: ['locked', 'story'] },
      { type: 'evidence_spot', name: 'vault_manifest', offset: { q: 0, r: 1 }, tags: ['clue', 'document'] },
      { type: 'evidence_spot', name: 'player_heritage', offset: { q: -1, r: -1 }, tags: ['clue', 'story', 'player_backstory'] },
    ],
    zones: [
      { type: 'public_area', name: 'corridor', tiles: [{ q: 0, r: 0 }, { q: 0, r: 1 }, { q: 0, r: -1 }], tags: ['passage'] },
      { type: 'loot_area', name: 'all_vaults', tiles: [{ q: 1, r: 0 }, { q: -1, r: 0 }, { q: 1, r: 1 }, { q: -1, r: 1 }, { q: 1, r: -1 }, { q: -1, r: -1 }], priority: 1, tags: ['high_value', 'locked'] },
    ],
  ...
  // -------------------------------------------------------------------------
  {
    ...
    markers: [
      { type: 'entrance', name: 'from_maintenance', offset: { q: 0, r: 2 }, facing: 5, tags: ['interior'] },
      { type: 'exit', name: 'mountain_exit', offset: { q: 0, r: -2 }, facing: 2, tags: ['exterior', 'escape', 'final'] },
      { type: 'hiding_spot', name: 'rubble_cover', offset: { q: 1, r: 0 }, tags: ['cover'] },
      { type: 'evidence_spot', name: 'abandoned_supplies', offset: { q: -1, r: 0 }, tags: ['clue', 'evacuation'] },
    ],
    zones: [
      { type: 'public_area', name: 'escape_tunnel', tiles: [{ q: 0, r: 0 }, { q: 0, r: 1 }, { q: 0, r: 2 }, { q: 0, r: -1 }, { q: 0, r: -2 }], tags: ['passage', 'escape'] },
    ],
