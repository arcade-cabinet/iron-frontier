...
const saloon_keeper_schedule: ScheduleTemplate = {
  ...
  entries: [
    { startHour: 0, endHour: 2, activity: 'work', locationMarker: '{{saloon}}', dialogueOverride: 'late_night_barkeep' },
    ...
    { startHour: 12, endHour: 14, activity: 'work', locationMarker: '{{saloon}}', dialogueOverride: 'afternoon_setup' },
    { startHour: 14, endHour: 18, activity: 'work', locationMarker: '{{saloon}}' },
    { startHour: 18, endHour: 24, activity: 'work', locationMarker: '{{saloon}}', dialogueOverride: 'evening_barkeep' },
  ],
...
const store_owner_schedule: ScheduleTemplate = {
  ...
  entries: [
    ...
    { startHour: 8, endHour: 12, activity: 'work', locationMarker: '{{general_store}}', dialogueOverride: 'morning_shopkeep' },
...
const blacksmith_schedule: ScheduleTemplate = {
  ...
  entries: [
    ...
    { startHour: 6, endHour: 10, activity: 'work', locationMarker: '{{blacksmith}}', dialogueOverride: 'morning_forge' },
...
const doctor_schedule: ScheduleTemplate = {
  ...
  entries: [
    { startHour: 0, endHour: 6, activity: 'sleep', locationMarker: '{{home}}', dialogueOverride: 'on_call_night' },
    { startHour: 6, endHour: 7, activity: 'eat', locationMarker: '{{home}}' },
    { startHour: 7, endHour: 8, activity: 'travel', locationMarker: '{{doctor}}' },
    { startHour: 8, endHour: 12, activity: 'work', locationMarker: '{{doctor}}', dialogueOverride: 'morning_patients' },
...
const banker_schedule: ScheduleTemplate = {
  ...
  entries: [
    ...
    { startHour: 9, endHour: 12, activity: 'work', locationMarker: '{{bank}}', dialogueOverride: 'morning_banking' },
...
const bartender_schedule: ScheduleTemplate = {
  ...
  entries: [
    { startHour: 0, endHour: 3, activity: 'work', locationMarker: '{{saloon}}', dialogueOverride: 'late_night_service' },
    ...
    { startHour: 17, endHour: 24, activity: 'work', locationMarker: '{{saloon}}', dialogueOverride: 'evening_service' },
  ],
...
const ranch_hand_schedule: ScheduleTemplate = {
  ...
  entries: [
    ...
    { startHour: 5, endHour: 8, activity: 'work', locationMarker: '{{ranch}}', dialogueOverride: 'morning_chores' },
...
const miner_schedule: ScheduleTemplate = {
  ...
  entries: [
    ...
    { startHour: 7, endHour: 12, activity: 'work', locationMarker: '{{mine}}', dialogueOverride: 'mining_shift' },
...
const railroad_worker_schedule: ScheduleTemplate = {
  ...
  entries: [
    ...
    { startHour: 6, endHour: 11, activity: 'work', locationMarker: '{{rail_line}}', dialogueOverride: 'track_work' },
...
const sheriff_schedule: ScheduleTemplate = {
  ...
  entries: [
    { startHour: 0, endHour: 2, activity: 'patrol', locationMarker: '{{town_center}}', dialogueOverride: 'night_patrol' },
    ...
    { startHour: 7, endHour: 9, activity: 'patrol', locationMarker: '{{town_center}}', dialogueOverride: 'morning_patrol' },
    ...
    { startHour: 18, endHour: 19, activity: 'eat', locationMarker: '{{home}}' },
    { startHour: 19, endHour: 21, activity: 'patrol', locationMarker: '{{saloon}}', dialogueOverride: 'evening_patrol' },
...
const deputy_schedule: ScheduleTemplate = {
  ...
  entries: [
    { startHour: 0, endHour: 4, activity: 'patrol', locationMarker: '{{town_center}}', dialogueOverride: 'night_watch' },
    ...
    { startHour: 19, endHour: 24, activity: 'patrol', locationMarker: '{{town_center}}', dialogueOverride: 'evening_patrol' },
  ],
...
const preacher_schedule: ScheduleTemplate = {
  ...
  entries: [
    { startHour: 0, endHour: 5, activity: 'sleep', locationMarker: '{{home}}' },
    { startHour: 5, endHour: 6, activity: 'pray', locationMarker: '{{church}}', dialogueOverride: 'morning_devotion' },
    { startHour: 6, endHour: 7, activity: 'eat', locationMarker: '{{home}}' },
    { startHour: 7, endHour: 9, activity: 'work', locationMarker: '{{church}}' },
    { startHour: 9, endHour: 12, activity: 'travel', locationMarker: '{{town_center}}', dialogueOverride: 'pastoral_visit' },
    { startHour: 12, endHour: 13, activity: 'eat', locationMarker: '{{home}}' },
    { startHour: 13, endHour: 16, activity: 'work', locationMarker: '{{church}}' },
    { startHour: 16, endHour: 18, activity: 'travel', locationMarker: '{{town_center}}', dialogueOverride: 'pastoral_visit' },
    { startHour: 18, endHour: 19, activity: 'eat', locationMarker: '{{home}}' },
    { startHour: 19, endHour: 20, activity: 'pray', locationMarker: '{{church}}', dialogueOverride: 'evening_prayer' },
    { startHour: 20, endHour: 21, activity: 'idle', locationMarker: '{{home}}' },
    { startHour: 21, endHour: 24, activity: 'sleep', locationMarker: '{{home}}' },
  ],
...
const gambler_schedule: ScheduleTemplate = {
  ...
  entries: [
    { startHour: 0, endHour: 4, activity: 'socialize', locationMarker: '{{saloon}}', dialogueOverride: 'late_night_cards' },
    ...
    { startHour: 18, endHour: 19, activity: 'eat', locationMarker: '{{saloon}}' },
    { startHour: 19, endHour: 24, activity: 'socialize', locationMarker: '{{saloon}}', dialogueOverride: 'card_game' },
  ],
...
const drifter_schedule: ScheduleTemplate = {
  ...
  entries: [
    ...
    { startHour: 9, endHour: 11, activity: 'idle', locationMarker: '{{town_center}}', dialogueOverride: 'drifter_talk' },
...
const prospector_schedule: ScheduleTemplate = {
  ...
  entries: [
    ...
    { startHour: 6, endHour: 12, activity: 'work', locationMarker: '{{claim}}', dialogueOverride: 'panning_gold' },
    ...
    { startHour: 18, endHour: 19, activity: 'shop', locationMarker: '{{assay_office}}', dialogueOverride: 'selling_gold' },
    { startHour: 19, endHour: 22, activity: 'socialize', locationMarker: '{{saloon}}', dialogueOverride: 'prospector_tales' },
...
const homesteader_schedule: ScheduleTemplate = {
  ...
  entries: [
    ...
    { startHour: 6, endHour: 8, activity: 'work', locationMarker: '{{homestead}}', dialogueOverride: 'morning_chores' },
    ...
    { startHour: 16, endHour: 18, activity: 'work', locationMarker: '{{homestead}}', dialogueOverride: 'evening_chores' },
...
const outlaw_schedule: ScheduleTemplate = {
  ...
  entries: [
    { startHour: 0, endHour: 4, activity: 'patrol', locationMarker: '{{hideout}}', dialogueOverride: 'outlaw_scheming' },
    ...
    { startHour: 17, endHour: 18, activity: 'work', locationMarker: '{{hideout}}', dialogueOverride: 'planning_job' },
    { startHour: 18, endHour: 20, activity: 'travel', locationMarker: '{{outskirts}}' },
    { startHour: 20, endHour: 24, activity: 'patrol', locationMarker: '{{outskirts}}', dialogueOverride: 'scouting' },
  ],
...
const automaton_schedule: ScheduleTemplate = {
  ...
  entries: [
    ...
    { startHour: 4, endHour: 5, activity: 'idle', locationMarker: '{{workshop}}', dialogueOverride: 'maintenance_mode' },
    { startHour: 5, endHour: 12, activity: 'work', locationMarker: '{{workplace}}' },
    { startHour: 12, endHour: 13, activity: 'idle', locationMarker: '{{workshop}}', dialogueOverride: 'refueling' },
    { startHour: 13, endHour: 20, activity: 'work', locationMarker: '{{workplace}}' },
    { startHour: 20, endHour: 21, activity: 'idle', locationMarker: '{{workshop}}', dialogueOverride: 'maintenance_mode' },
...
const hotel_guest_schedule: ScheduleTemplate = {
  ...
  entries: [
    ...
    { startHour: 11, endHour: 13, activity: 'travel', locationMarker: '{{town_center}}', dialogueOverride: 'sightseeing' },
    ...
    { startHour: 19, endHour: 22, activity: 'socialize', locationMarker: '{{saloon}}', dialogueOverride: 'tourist_questions' },
...
const elderly_schedule: ScheduleTemplate = {
  ...
  entries: [
    ...
    { startHour: 6, endHour: 7, activity: 'eat', locationMarker: '{{home}}' },
    { startHour: 7, endHour: 9, activity: 'idle', locationMarker: '{{home}}', dialogueOverride: 'old_timer_stories' },
    ...
    { startHour: 18, endHour: 19, activity: 'socialize', locationMarker: '{{church}}', dialogueOverride: 'reminiscing' },
...
const gunsmith_schedule: ScheduleTemplate = {
  ...
  entries: [
    ...
    { startHour: 8, endHour: 12, activity: 'work', locationMarker: '{{gunsmith}}', dialogueOverride: 'morning_repairs' },
...
const undertaker_schedule: ScheduleTemplate = {
  ...
  entries: [
    ...
    { startHour: 10, endHour: 12, activity: 'work', locationMarker: '{{cemetery}}', dialogueOverride: 'cemetery_work' },
...
const stable_hand_schedule: ScheduleTemplate = {
  ...
  entries: [
    ...
    { startHour: 6, endHour: 9, activity: 'work', locationMarker: '{{stable}}', dialogueOverride: 'morning_feeding' },
    ...
    { startHour: 17, endHour: 20, activity: 'work', locationMarker: '{{stable}}', dialogueOverride: 'evening_care' },
...
const telegraph_operator_schedule: ScheduleTemplate = {
  ...
  entries: [
    ...
    { startHour: 8, endHour: 12, activity: 'work', locationMarker: '{{telegraph}}', dialogueOverride: 'morning_messages' },
...
const bounty_hunter_schedule: ScheduleTemplate = {
  ...
  entries: [
    ...
    { startHour: 6, endHour: 10, activity: 'patrol', locationMarker: '{{outskirts}}', dialogueOverride: 'tracking' },
    { startHour: 10, endHour: 11, activity: 'travel', locationMarker: '{{town_center}}' },
    { startHour: 11, endHour: 12, activity: 'work', locationMarker: '{{sheriff_office}}', dialogueOverride: 'checking_bounties' },
    { startHour: 12, endHour: 13, activity: 'eat', locationMarker: '{{saloon}}' },
    ...
    { startHour: 18, endHour: 19, activity: 'eat', locationMarker: '{{saloon}}' },
    { startHour: 19, endHour: 21, activity: 'socialize', locationMarker: '{{saloon}}', dialogueOverride: 'gathering_intel' },
...
export function getAllSchedulesForRole(role: string): ScheduleTemplate[] {
  return Object.values(SCHEDULE_TEMPLATES).filter((schedule) =>
    schedule.validRoles.includes(role)
  );
}
