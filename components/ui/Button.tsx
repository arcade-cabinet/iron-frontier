...
const buttonVariants = cva(
  ...
  ),
  {
    variants: {
      ...
      size: {
        sm: cn("min-h-[44px] gap-1.5 rounded-md px-3", Platform.select({ web: "sm:min-h-[36px]" })),
        md: cn("min-h-[44px] px-4 py-2", Platform.select({ web: "sm:min-h-[40px]" })),
        lg: cn("min-h-[48px] rounded-md px-6", Platform.select({ web: "sm:min-h-[44px]" })),
      },
    },
    defaultVariants: {
      variant: "primary",
