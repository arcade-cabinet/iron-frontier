...
- [x] 7.1.1 Create `.github/workflows/ci.yml`
- [x] 7.1.2 Pin all actions to exact SHAs with version comments
- [x] 7.1.3 Add lint-and-typecheck job
- [x] 7.1.4 Add test job with coverage upload
- [x] 7.1.5 Add build-web job
- [x] 7.1.6 Add e2e-web job with Playwright
- [x] 7.1.7 Add build-mobile job with EAS Build
- [x] 7.1.8 Add deploy-web job for GitHub Pages
- [x] 7.1.9 Add release-android job for debug APKs
- [x] 7.1.10 Add release-please job

### 7.2 Configure GitHub Secrets
- [x] 7.2.1 Add `EXPO_TOKEN` secret
- [x] 7.2.2 Configure GitHub Pages permissions
- [x] 7.2.3 Test secrets are accessible in workflow

### 7.3 Setup GitHub Pages
- [x] 7.3.1 Enable GitHub Pages in repository settings
- [x] 7.3.2 Configure source to GitHub Actions
- [x] 7.3.3 Test deployment to GitHub Pages

### 7.4 Setup release-please
- [x] 7.4.1 Create `.release-please-manifest.json`
- [x] 7.4.2 Create `release-please-config.json`
- [x] 7.4.3 Configure release-please for node package
- [x] 7.4.4 Test release-please creates PR

### 7.5 Test CI Pipeline
- [x] 7.5.1 Push to test branch
- [x] 7.5.2 Verify lint-and-typecheck job runs
- [x] 7.5.3 Verify test job runs and uploads coverage
- [x] 7.5.4 Verify build-web job creates artifact
- [x] 7.5.5 Verify e2e-web job runs Playwright tests
- [x] 7.5.6 Fix any CI failures

### 7.6 Test Deployment
- [x] 7.6.1 Merge to main branch
- [x] 7.6.2 Verify web deploys to GitHub Pages
- [x] 7.6.3 Verify Android APKs build successfully
- [x] 7.6.4 Verify release-please creates release with APKs
- [x] 7.6.5 Test deployed web app works correctly

### 7.7 Validation
- [x] 7.7.1 CI pipeline runs successfully on push
- [x] 7.7.2 All jobs complete without errors
- [x] 7.7.3 Tests run in CI
- [x] 7.7.4 Web deploys to GitHub Pages automatically
- [x] 7.7.5 Android APKs attach to releases
- [x] 7.7.6 Deployed web app is accessible and functional
...
- [x] 8.1.1 Create Git tag `v0.1-monorepo` before deletion
- [x] 8.1.2 Push tag to remote
- [x] 8.1.3 Delete `apps/` directory
- [x] 8.1.4 Delete `packages/` directory
- [x] 8.1.5 Delete `pnpm-workspace.yaml`
- [x] 8.1.6 Delete workspace-related configs
- [x] 8.1.7 Commit deletion with clear message

### 8.2 Update Documentation
- [x] 8.2.1 Update `README.md` with new project structure
- [x] 8.2.2 Update `AGENTS.md` with Expo-specific instructions
- [x] 8.2.3 Update `docs/DEVELOPMENT_GUIDE.md` for single Expo app
- [x] 8.2.4 Update `docs/ARCHITECTURE_V2.md` if needed
- [x] 8.2.5 Remove references to monorepo structure
- [x] 8.2.6 Add deployment instructions (GitHub Pages, APKs)

### 8.3 Create Migration Guide
- [x] 8.3.1 Create `docs/MIGRATION_GUIDE.md`
- [x] 8.3.2 Document all breaking changes
- [x] 8.3.3 Provide upgrade instructions for developers
- [x] 8.3.4 Document new commands and workflows
- [x] 8.3.5 Document rollback procedure

### 8.4 Final Validation
- [x] 8.4.1 Fresh clone of repository
- [x] 8.4.2 Run `npm install` - succeeds
- [x] 8.4.3 Run `expo start` - launches successfully
- [x] 8.4.4 Run `npm test` - all tests pass
- [x] 8.4.5 Run `npm run typecheck` - no errors
- [x] 8.4.6 Build web: `npx expo export:web` - succeeds
- [x] 8.4.7 Build Android: `eas build --platform android --profile preview` - succeeds
- [x] 8.4.8 Test on all supported devices - works correctly

### 8.5 Validation
- [x] 8.5.1 Old monorepo structure removed
- [x] 8.5.2 Git tag `v0.1-monorepo` exists
- [x] 8.5.3 Documentation updated and accurate
- [x] 8.5.4 Migration guide complete
- [x] 8.5.5 Fresh clone works correctly
- [x] 8.5.6 All commands work as documented
