    ...
    <AnimatePresence>
      ...
      >
        ...
        <motion.div
          ...
          animate={{ scale: 1, y: 0 }}
          exit={{ scale: 0.9, y: 20 }}
          className="relative bg-amber-950 border-2 border-red-900/60 rounded-xl max-w-sm sm:max-w-md w-full mx-4 overflow-hidden shadow-2xl"
        >
          {/* Header Decoration */}
          ...
          <div className="p-4 sm:p-8 text-center">
            ...
            >
              <div className="w-20 h-20 sm:w-24 sm:h-24 mx-auto bg-red-950/50 border-2 border-red-800/50 rounded-full flex items-center justify-center">
                <SkullIcon className="w-12 h-12 sm:w-16 sm:h-16 text-red-600" />
              </div>
            </motion.div>
            ...
            >
              ...
              <p className="text-amber-300/90 mb-1 text-sm sm:text-base">
                {playerName} met their end on the frontier.
              </p>
              <p className="text-amber-500/60 text-xs sm:text-sm mb-4 sm:mb-6">
            ...
            <motion.div
              ...
              animate={{ opacity: 1 }}
              transition={{ delay: 1 }}
              className="mt-4 sm:mt-8 pt-3 sm:pt-4 border-t border-amber-800/30"
            >
              <p className="text-amber-600/40 text-[10px] sm:text-xs italic">
