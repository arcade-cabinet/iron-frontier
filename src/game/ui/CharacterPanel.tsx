...
export function CharacterPanel() {
  ...
  return (
    <Sheet open={isOpen} onOpenChange={() => togglePanel('character')}>
      <SheetContent side="left" className="w-full sm:w-80 bg-amber-950 border-amber-700">
        <SheetHeader className="pb-3 sm:pb-4">
          <SheetTitle className="text-amber-100 flex items-center gap-2 text-base sm:text-lg">
        ...
        <div className="mb-3 sm:mb-4">
          <div className="text-[9px] sm:text-[10px] text-amber-500/70 uppercase tracking-wider mb-1.5 sm:mb-2">
            Combat Stats
          </div>
