...
export function MenuPanel() {
  ...
  return (
    <Sheet open={menuOpen} onOpenChange={() => togglePanel('menu')}>
      <SheetContent side="left" className="w-[320px] bg-amber-950 border-amber-700 p-0">
        <SheetHeader className="p-4 pb-2 border-b border-amber-800/50">
          <SheetTitle className="text-amber-100 text-lg font-bold tracking-wide">
            Iron Frontier
          </SheetTitle>
        </SheetHeader>

        <Tabs defaultValue="game" className="h-[calc(100%-60px)]">
          <TabsList className="w-full rounded-none bg-amber-900/30 border-b border-amber-800/50 p-0">
            <TabsTrigger
              value="game"
              className="flex-1 rounded-none py-2.5 data-[state=active]:bg-amber-800/50 data-[state=active]:text-amber-100 text-amber-400"
            >
              Game
            </TabsTrigger>
            <TabsTrigger
            ...
            <ScrollArea className="h-full">
              <div className="p-4 space-y-4">
                ...
                <div className="space-y-2">
                  <Button
                    variant="outline"
                    className="w-full border-amber-700 text-amber-200 hover:bg-amber-800/50 justify-start gap-2 h-10"
                    onClick={handleSave}
                  >
                    <SaveIcon />
                    Save Progress
                  ...
                  <Button
                    variant="outline"
                    className="w-full border-red-700/50 text-red-400 hover:bg-red-900/30 justify-start gap-2 h-10"
        ...
        <div className="absolute bottom-2 left-0 right-0 text-center">
          <p className="text-amber-600/40 text-[10px]">
            Iron Frontier v0.1
          </p>
        </div>
      </SheetContent>
