/**
 * Iron Frontier - Main Quest: The Inheritance
 *
      ...
      objectives: [
        {
          ...
          markerTarget: { type: 'location', locationId: 'dusty_springs' },
          completionRadius: 30,
        },
        {
          id: 'obj_find_address',
          ...
          mapMarker: { locationId: 'dusty_springs', markerLabel: 'The Address' },
          markerTarget: {
            type: 'building',
      ...
      objectives: [
        {
          ...
          mapMarker: { locationId: 'dusty_springs', markerLabel: "Sheriff's Office" },
          markerTarget: {
            type: 'building',
        ...
        },
        {
          ...
          markerTarget: { type: 'npc', npcId: 'sheriff_cole' },
        },
      ],
      stageRewards: { xp: 50, gold: 0, items: [], reputation: { law: 10 } },
    },
    {
      ...
      stageRewards: { xp: 100, gold: 25, items: [], reputation: { freeminers: 25 } },
    },
  ],
