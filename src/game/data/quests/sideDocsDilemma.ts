/**
 * Iron Frontier - Side Quest: Doc's Dilemma
 *
...
export const DocsDilemma: Quest = {
  ...
  stages: [
      ...
      objectives: [
        {
          ...
          mapMarker: { locationId: 'dusty_springs', markerLabel: "Doc's Clinic" },
          markerTarget: { type: 'npc', npcId: 'doc_chen' },
        },
        {
          id: 'obj_get_list',
      ...
      objectives: [
        {
          ...
          mapMarker: { locationId: 'junction_city', markerLabel: 'IVRC Pharmacy' },
          markerTarget: {
            type: 'building',
        ...
        },
        {
          ...
          mapMarker: { locationId: 'coppertown', markerLabel: 'Company Store' },
          markerTarget: {
            type: 'building',
    ...
    },
    {
      ...
      stageRewards: { xp: 25, gold: 0, items: [], reputation: { townfolk: 15 } },
    },
  ],
