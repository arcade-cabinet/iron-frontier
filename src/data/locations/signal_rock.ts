...
the old carvings glow faint blue, but that's probably just miner's whiskey talking.`,
  ...
  slots: [
    ...
    // ========================================
    {
      ...
      markers: [
        { type: 'vantage_point', name: 'rock_summit', offset: { q: 0, r: 0 }, tags: ['lookout', 'elevated', 'best_view'] },
        { type: 'evidence_spot', name: 'ancient_carvings', offset: { q: -1, r: 1 }, tags: ['lore', 'mystery', 'ancient'] },
        { type: 'entrance', name: 'climb_path', offset: { q: 2, r: 2 }, facing: 3, tags: ['difficult', 'approach'] },
      ],
      zones: [
        { type: 'public_area', name: 'rock_base', tiles: [{ q: 2, r: 1 }, { q: 2, r: 2 }], tags: ['approach'] },
      ],
    ...
    // ========================================
    {
      ...
      markers: [
        { type: 'vantage_point', name: 'platform_view', offset: { q: 0, r: 0 }, facing: 0, tags: ['lookout', 'wooden_structure'] },
        { type: 'spawn_point', name: 'lookout_post', offset: { q: 0, r: 0 }, facing: 0, tags: ['npc', 'guard', 'outlaw'] },
        { type: 'storage', name: 'signal_supplies', offset: { q: 0, r: 1 }, tags: ['torches', 'oil'] },
      ],
      zones: [
        { type: 'restricted_area', name: 'platform', tiles: [{ q: 0, r: 0 }], priority: 1, tags: ['guarded'] },
      ],
    ...
    // ========================================
    {
      ...
      markers: [
        { type: 'spawn_point', name: 'fire_tender', offset: { q: 0, r: 0 }, tags: ['npc', 'outlaw', 'signal'] },
        { type: 'evidence_spot', name: 'signal_codes', offset: { q: 1, r: 0 }, tags: ['clue', 'communication'] },
        { type: 'storage', name: 'fuel_pile', offset: { q: -1, r: 0 }, tags: ['wood', 'supplies'] },
      ],
      zones: [
        { type: 'event_stage', name: 'signal_area', tiles: [{ q: 0, r: 0 }, { q: 1, r: 0 }, { q: -1, r: 0 }], tags: ['signal', 'communication'] },
      ],
    ...
    // ========================================
    {
      ...
      markers: [
        { type: 'evidence_spot', name: 'sun_symbol', offset: { q: 0, r: 0 }, tags: ['ancient', 'mystery', 'lore'] },
        { type: 'evidence_spot', name: 'spiral_carving', offset: { q: 1, r: 0 }, tags: ['ancient', 'mystery', 'map_hint'] },
        { type: 'conversation_spot', name: 'meditation_spot', offset: { q: 0, r: 1 }, tags: ['quiet', 'lore'] },
      ],
      zones: [
        { type: 'event_stage', name: 'carving_area', tiles: [{ q: 0, r: 0 }, { q: 1, r: 0 }], tags: ['lore', 'discovery'] },
      ],
    ...
    // ========================================
    {
      ...
      markers: [
        { type: 'evidence_spot', name: 'outlaw_mark_north', offset: { q: 0, r: 0 }, tags: ['trail', 'rattlesnake_canyon'] },
        { type: 'evidence_spot', name: 'outlaw_mark_east', offset: { q: 1, r: 0 }, tags: ['trail', 'dead_mans_gulch'] },
        { type: 'evidence_spot', name: 'outlaw_mark_west', offset: { q: -1, r: 1 }, tags: ['trail', 'safe_passage'] },
      ],
      zones: [
        { type: 'public_area', name: 'junction', tiles: [{ q: 0, r: 0 }, { q: 1, r: 0 }, { q: 0, r: 1 }, { q: -1, r: 1 }], tags: ['navigation'] },
      ],
    ...
    // ========================================
    {
      ...
      markers: [
        { type: 'storage', name: 'emergency_cache', offset: { q: 0, r: 0 }, tags: ['hidden', 'supplies', 'water'] },
        { type: 'hiding_spot', name: 'cache_hollow', offset: { q: 1, r: 0 }, tags: ['cover'] },
      ],
      zones: [
        { type: 'loot_area', name: 'cache_contents', tiles: [{ q: 0, r: 0 }], tags: ['supplies', 'hidden'] },
      ],
  ...
  baseTiles: [
    ...
    { coord: { q: 10, r: 18 }, terrain: 'dirt', edges: ['none', 'road', 'none', 'none', 'none', 'road'] },
    { coord: { q: 10, r: 19 }, terrain: 'dirt', edges: ['none', 'road', 'none', 'none', 'none', 'road'] },
