...
export * from '@iron-frontier/shared/types/engine';
...
export interface ChunkData {
  ...
  // Content
  structures: import('@iron-frontier/shared/types/engine').Structure[];
  props: import('@iron-frontier/shared/types/engine').Prop[];
  npcs: NPC[];
  items: WorldItem[];
